...
.header .logo-dark { display: none;  -webkit-border-radius: 40px; -moz-border-radius: 40px; -ms-border-radius: 40px; -o-border-radius: 40px; border-radius: 40px; }
.header .logo-light,
.header.active .logo-dark { display: block;  -webkit-border-radius: 40px; -moz-border-radius: 40px; -ms-border-radius: 40px; -o-border-radius: 40px; border-radius: 40px;}
.nav-open-btn {
  font-size: 3.5rem;
  color: var(--white);
}
...
.about{
  background-color: rgba(97, 187, 212, 0.411);
}
...
.feature { background-color: antiquewhite; }
.feature .container {
  display: grid;
  gap: 50px;
}
...
.stats-card .card-text:hover {
  animation: jigjag 0.5s ease-in-out;
  -webkit-animation: jigjag 0.5s ease-in-out;
}
...
.project-card:hover .card-meta-item { color: var(--violet-blue-crayola); }
...
.project{
  background-color: rgba(102, 155, 190, 0.454);
}

.project-card:hover {
  animation: slidePop 0.5s ease-in-out ;
  -webkit-animation: slidePop 0.5s ease-in-out ;
}
...
.cta { background-color: rgba(76, 111, 124, 0.599); }
.cta .container {
